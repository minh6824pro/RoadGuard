    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(v -> {
            ...
            if (code.length() == 4) {
                ...
                Toast.makeText(this, "Mã xác thực: " + code, Toast.LENGTH_SHORT).show();
                Intent  resetPasswordIntent = new Intent(VerificationResetPasswordActivity.this,ResetPasswordAcivity.class);
                activityResultLauncher.launch(resetPasswordIntent);
